!(function(global, utils) {
    ...
    describe('EditableList widget', function() {
        ...
        describe('Rendering and List manipulation', function() {
            var node, list;
            ...
            beforeEach(function() {
                ...
                list = new global.app.widgets
                            .EditableList({
                                ...
                                // no UI is provided to modify the list
                                // editable    : false
                            });
            });
            ...
            it('should render into the provided DOM node', function() {
                ...
                expect(node.querySelectorAll('li[data-id] input[type="text"]').length).toEqual(2);
                expect(node.querySelectorAll('li[data-id] button.item-remove').length).toEqual(2);
            });
            ...
            it('should add item if a valid config is provided for the addItem method', function() {
                ...
                expect(node.querySelectorAll('li[data-id] input[type="text"]').length).toEqual(3);
                expect(node.querySelectorAll('li[data-id] button.item-remove').length).toEqual(3);
            });
            ...
            it('should remove an existing item if a valid id is provided for removeItem method', function() {
                list.render();
            ...
            it('should remove an item if remove item button is pressed', function() {
                list.render();

                var removeItem = document.querySelectorAll('li[data-id] button.item-remove')[1];

                utils.dispatchEvent(removeItem, 'click');
